...
public final class ShortcutActions {
     ...
     *     {@link ShortcutActions#exec(Runnable, Component)} instead. To limit
     *     the availability of the shortcut, use
     ...
     * @return {@link ShortcutRegistration} for configuring the shortcut.
     */
    public static ShortcutRegistration exec(Runnable runnable) {
        if (runnable == null) {
            throw new InvalidParameterException(
     ...
     *                  available or not
     * @return
     * @see ShortcutActions#exec(Runnable)
     */
    public static ShortcutRegistration exec(Runnable runnable, Component owner) {
        if (runnable == null) {
            throw new InvalidParameterException(
                    String.format(NULL_PARAM, "runnable"));
        }
